...
declare module 'glob:./sources/{*.ts,**/index.ts}' {
  ...
  export const theglobeandmail: typeof import('./sources/theglobeandmail')
  export const thepaper: typeof import('./sources/thepaper')
  export const thestar: typeof import('./sources/thestar')
